...
@app.route("/")
def index():
    return send_file(RAIZ / "index.html", mimetype="text/html")


@app.route("/styles.css")
def styles():
    return send_file(RAIZ / "styles.css", mimetype="text/css")


@app.route("/app.js")
def frontend_js():
    return send_file(RAIZ / "app.js", mimetype="text/javascript")
