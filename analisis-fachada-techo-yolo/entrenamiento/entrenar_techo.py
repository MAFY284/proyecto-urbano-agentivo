...
LOCK_PATH = os.path.join('entrenamiento', '.locks', 'entrenamiento_techo.lock')
...
if os.path.isfile(LOCK_PATH):
    ...
    try:
        ...
        print(f"❌ Ya hay un entrenamiento de 'entrenamiento_techo' corriendo (PID {pid_previo}). "
...
# Entrenar el modelo para TECHOS/EDIFICIOS SATELITALES
print("🚀 Iniciando entrenamiento de Techos/Edificios Satelitales...")
results = model.train(
    data='datasets/dataset_techo.yaml',
    epochs=200,
    imgsz=640,
    ...
    patience=0,        # sin EarlyStopping — se piden 200 épocas a propósito, que se cumplan
    name=RUN_NAME,
    plots=True         # Generar gráficas de entrenamiento
)

print("✅ ¡Entrenamiento de Techos completado!")
