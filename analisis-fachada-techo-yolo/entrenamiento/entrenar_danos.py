...
LOCK_PATH = os.path.join('entrenamiento', '.locks', 'entrenamiento_danos.lock')
...
if os.path.isfile(LOCK_PATH):
    ...
    try:
        ...
        print(f"❌ Ya hay un entrenamiento de 'entrenamiento_danos' corriendo (PID {pid_previo}). "
...
# Modelo especializado en daños/deterioro de fachada (grietas, corrosión,
# desprendimiento de aplanado/azulejo, etc.), entrenamiento "parte por parte".
model = YOLO(modelo_base)

print("🚀 Iniciando entrenamiento de Daños...")
results = model.train(
    data='datasets/dataset_danos.yaml',
    epochs=500,
    imgsz=640,
...
print("✅ ¡Entrenamiento de Daños completado!")
