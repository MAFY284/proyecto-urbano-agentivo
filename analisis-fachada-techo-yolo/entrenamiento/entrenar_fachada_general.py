...
RUN_NAME = 'entrenamiento_fachada_general'
...
LOCK_PATH = os.path.join('entrenamiento', '.locks', 'entrenamiento_fachada_general.lock')
...
if os.path.isfile(LOCK_PATH):
    ...
    try:
        ...
        print(f"❌ Ya hay un entrenamiento de 'entrenamiento_fachada_general' corriendo (PID {pid_previo}). "
...
# Modelo de elementos arquitectónicos de fachada (25 clases: balcones, cornisas,
# pilares, ventanas, puertas, etc.), entrenamiento "parte por parte".
model = YOLO(modelo_base)

print("🚀 Iniciando entrenamiento de Fachada General...")
results = model.train(
    data='datasets/dataset_fachada_general.yaml',
    epochs=500,
    imgsz=640,
...
print("✅ ¡Entrenamiento de Fachada General completado!")
