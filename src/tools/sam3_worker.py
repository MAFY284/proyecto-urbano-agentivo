...
# -*- coding: utf-8 -*-
"""
Worker de SAM3, pensado para correr con el Python de src/tools/env_sam3
(3.12 + torch 2.7), invocado como subproceso desde comparador.py (que corre en
el venv principal, con Detectron2/YOLO). Los dos entornos no pueden convivir
en el mismo proceso.
