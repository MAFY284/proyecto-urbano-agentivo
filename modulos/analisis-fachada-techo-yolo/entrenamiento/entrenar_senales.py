...
RUN_NAME = 'entrenamiento_senales'
...
LOCK_PATH = os.path.join('entrenamiento', '.locks', 'entrenamiento_senales.lock')
...
if os.path.isfile(LOCK_PATH):
    ...
    try:
        ...
        print(f"❌ Ya hay un entrenamiento de 'entrenamiento_senales' corriendo (PID {pid_previo}). "
...
# Modelo de señalamiento vial (47 clases). NO es un modelo de fachada — es una
# categoría independiente que venía mezclada en la carpeta "Facade/Señales".
model = YOLO(modelo_base)

print("🚀 Iniciando entrenamiento de Señales...")
results = model.train(
    data='datasets/dataset_senales.yaml',
    epochs=500,
    imgsz=640,
...
print("✅ ¡Entrenamiento de Señales completado!")
