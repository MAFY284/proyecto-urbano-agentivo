...
RUN_NAME = 'entrenamiento_ventanas'
...
LOCK_PATH = os.path.join('entrenamiento', '.locks', 'entrenamiento_ventanas.lock')
...
if os.path.isfile(LOCK_PATH):
    ...
    try:
        ...
        print(f"❌ Ya hay un entrenamiento de 'entrenamiento_ventanas' corriendo (PID {pid_previo}). "
...
# Modelo especializado SOLO en ventanas (clase única), entrenamiento "parte por parte".
model = YOLO(modelo_base)

print("🚀 Iniciando entrenamiento de Ventanas...")
results = model.train(
    data='datasets/dataset_ventanas.yaml',
    epochs=500,
    imgsz=640,
...
print("✅ ¡Entrenamiento de Ventanas completado!")
