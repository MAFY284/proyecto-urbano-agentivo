...
RUN_NAME = 'entrenamiento_fachada'
...
LOCK_PATH = os.path.join('entrenamiento', '.locks', f'{RUN_NAME}.lock')
...
if os.path.isfile(LOCK_PATH):
    ...
    try:
        ...
        print(f"❌ Ya hay un entrenamiento de '{RUN_NAME}' corriendo (PID {pid_previo}). "
...
print("🚀 Iniciando entrenamiento de Fachadas Callejeras...")
results = model.train(
    data='datasets/dataset_fachadas.yaml',
    epochs=500,
    imgsz=640,
    batch=16,          # Ajusta según memoria de las GPUs
...
print("✅ ¡Entrenamiento de Fachadas completado!")
