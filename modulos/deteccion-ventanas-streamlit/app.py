...
# Los pesos viven en el almacén único del proyecto: config/checkpoints/comparador
# (raíz del repositorio). Si existe una carpeta models/ local, tiene prioridad.
MODELS_DIR = os.path.join(BASE_DIR, "models")
if not os.path.isdir(MODELS_DIR):
    MODELS_DIR = os.path.abspath(os.path.join(
        BASE_DIR, "..", "..", "config", "checkpoints", "comparador"))
